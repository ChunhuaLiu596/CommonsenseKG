...
#### Usage
The following is an example about how to use OpenEA in Python (We assume that you have already downloaded our [datasets](https://www.dropbox.com/s/hbyzesmz1u7ejdu/OpenEA_dataset.zip?dl=0) and configured the hyperparameters as in the [examples](https://github.com/nju-websoft/OpenEA/tree/master/run/args).)
```python
import openea as oa
...
For example, if you want to run BootEA on D-W-15K (V2) using the first split, please execute the following script:

```bash
python main_from_args.py ./args/bootea_args_15K.json DBP_en_WD_en_15K_V1 721_5fold/1/
CUDA_VISIBLE_DEVICES=5 python main_from_args.py ./args/iptranse_args_15K.json C_S 721_5fold/1/ 1.0 1.0
CUDA_VISIBLE_DEVICES=4 python main_from_args.py ./args/iptranse_args_15K.json C_S 271_5fold/1/ 1.0 1.0
tensorboard --logdir=run1:"/home/.../test",run2:"/home/.../test" 
tensorboard --logdir=run1:"../../output/results/IPTransE/C_S/271_5fold/1/20200601100303/train/",run2:"../../output/results/IPTransE/C_S/271_5fold/1/20200601100303/test/"
tensorboard --logdir="../../output/results/IPTransE/C_S/271_5fold/1/20200608160013/"
```
